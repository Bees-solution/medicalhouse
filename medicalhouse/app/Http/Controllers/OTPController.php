...
class OTPController extends Controller
{
    ...
    {
        try {
          // Validate request (✅ added doctor_id)
          $validated = $request->validate([
            'specialty' => 'required',
            'doctor' => 'required',
            'doctor_id' => 'required', // ✅ ADD THIS
            'schedule' => 'required',
            ...
            // Send OTP via Notify.lk service
    ...
    public function verifyOtp(Request $request)
    {
        ...
        // Check OTP match from DB
        $formattedPhone = '94' . substr($appointmentData['contact'], 1);
        $otpRecord = OTP::where('phone_number', $formattedPhone)
        ...
        // ✅ Store verified appointment in session
        Session::forget('otp');
        Session::put('verified_appointment', [
            'doctor' => $appointmentData['doctor_id'], // uses the ID ✅
        ...
        \Log::info('Verified Appointment Data Stored in Session:', [
            'appointment' => Session::get('verified_appointment')
        ]);
